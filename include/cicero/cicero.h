...
// note: cicero will not touch the user data, however it is passed back to the
// user as non-const.
...
struct cicero_savepos {
    ...
    uint16_t hscr[CICERO_NSQS];  // if playing horizontally at square, how many
                                 // additional points you'd score
