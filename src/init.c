...
void cicero_init_ex(cicero *e, cicero_callbacks callbacks,
    ...
    e->s.double_letter_squares = scoring.double_letter_squares
                                     ? scoring.double_letter_squares
                                     : &scrabble__double_letter_squares[0];
    e->s.triple_letter_squares = scoring.triple_letter_squares
                                     ? scoring.triple_letter_squares
                                     : &scrabble__triple_letter_squares[0];
    e->s.double_word_squares = scoring.double_word_squares
                                   ? scoring.double_word_squares
                                   : &scrabble__double_word_squares[0];
    e->s.triple_word_squares = scoring.triple_word_squares
                                   ? scoring.triple_word_squares
                                   : &scrabble__triple_word_squares[0];
    e->s.letter_values = scoring.letter_values ? scoring.letter_values
                                               : &scrabble__letter_values[0];
